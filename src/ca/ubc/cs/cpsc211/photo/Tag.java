...
public class Tag implements Serializable
{
    ...
    /**
     * Create a new tag with the provided name and set its added date to the
     * current time. Should only be called by a TagManager. Clients should use
     * tagManager.createTag(name) to create tags.
     */
    Tag( String name )
    {
        this.name = name;
    ...
    /**
     * Set the tag name. Should only be called by a TagManager. Clients should
     * use tagManager.renameTag(oldName, newName) to rename tags.
     */
